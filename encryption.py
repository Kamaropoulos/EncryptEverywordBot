...
if __name__ == '__main__':
	functions_list = [Hash_HMAC, Hash_MD2, Hash_MD4, Hash_MD5, Hash_RIPEMD, Hash_SHA, Hash_SHA224, Hash_SHA256, Hash_SHA384, Hash_SHA512, Cipher_ARC4, Cipher_Caesar]
	function_to_call = random.choice(functions_list)
	result = function_to_call("Hello")
	print "Function: " + function_to_call.__name__
	print "Result: " + result
